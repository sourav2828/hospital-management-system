...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/logo 2.png" height="55px" style="margin-top: -12px;"></a>
                </div>
        ...
        <!-- 1st section start -->
        <section id="promo-1" class="content-block promo-1 min-height-600px bg-offwhite" style="padding-bottom: 0px; padding-top: 0px;">
            <div class="container" style="background: linear-gradient(to right, #83a4d4, #b6fbff); width: 100vw; height: 98vh; padding-top: 250px; padding-left: 20vw;">
                <div class="row">
                    <div class="col-md-5">
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© Chandigarh University <a href ="">Doctor Appointment System </a></p>
